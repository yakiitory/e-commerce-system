...
class Product(DateMixin):
    ...
    # Contextual
    keywords: list[str] = field(default_factory=list) #TODO: Implement NLP for Title+description
    ...
    seasonal_relevance: list[str] | None = None # Something like, ["Halloween", "Easter"]
